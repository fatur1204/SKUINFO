...
import static com.idpskuinfo.skuinfo.db.DatabaseContract.TABLE_NAME_CURINFO;

public class CurrencyHelper {
    private static final String DATABASE_TABLE = TABLE_NAME_CURINFO;
    ...
    public int update(String id, ContentValues values) {
        return database.update(DATABASE_TABLE, values, DatabaseContract.CurrColumns.CURRID + " = ?", new String[]{id});
    }
